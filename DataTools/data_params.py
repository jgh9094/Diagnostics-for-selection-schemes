...
DATA_LIST = [POP_FIT_AVG,POP_FIT_MAX,POP_OPT_MAX,POP_UNI_OBJ,POP_STR_MAX,UNI_STR_POS,PARETO_CNT,ARCHIVE_CNT,PMIN,ARC_ACTI_GENE,OVERLAP,POP_MAX_TRT,POP_MAX_GENE]
