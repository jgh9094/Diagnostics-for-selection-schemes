...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{end}\OperatorTok{$}\NormalTok{Sigma =}\StringTok{ }\KeywordTok{factor}\NormalTok{(best}\OperatorTok{$}\NormalTok{Sigma, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\FloatTok{0.0}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.3}\NormalTok{, }\FloatTok{0.6}\NormalTok{, }\FloatTok{1.2}\NormalTok{, }\FloatTok{5.0}\NormalTok{, }\FloatTok{2.5}\NormalTok{))}
\KeywordTok{group_by}\NormalTok{(end, Sigma) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{count =} \KeywordTok{n}\NormalTok{(),}
    \DataTypeTok{na_cnt =} \KeywordTok{sum}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(pop_fit_max)),}
...
## 6 5        50      0  85.6  100.   97.5  100   3.56
## 7 2.5      50      0  82.6   99.5  96.6  100   5.67
\end{verbatim}
...
## 6 5        50      0  83.1   96.1  95.0  100.  8.23
## 7 2.5      50      0  79.2   95.1  93.7  100. 10.3
\end{verbatim}
...
## 6 5        50      0 2856.  3045. 3041. 3182.  94.0
## 7 2.5      50      0 3299.  3434. 3456. 3599. 136.
\end{verbatim}
...
## 5   < 2e-16 < 2e-16 < 2e-16 < 2e-16 < 2e-16 -      
## 2.5 < 2e-16 < 2e-16 < 2e-16 < 2e-16 < 2e-16 1.00000
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 6 5        50      0  82.7   90.1  91.1  100. 5.86 
## 7 2.5      50      0  85.2   97.9  96.6  100. 5.17
\end{verbatim}
