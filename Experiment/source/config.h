...
EMP_BUILD_CONFIG( DiaConfig,
  ...
  GROUP(DIAGNOSTICS, "How do environmental interactions work?"),
  VALUE(TARGET,              double,     100.0,      "Target that traits are trying to optimize towards."),
  VALUE(SOLUTION_THRESH,     double,      0.05,      "Percentage of error we are allowing, based of TARGET (TARGET * SOLUTION_THRESH)."),
  ...
  GROUP(MUTATIONS, "Mutation rates for DiaOrgs."),
