...
```{r pfs-ord-mvc-per-sli, warning=FALSE}
# 80% and final generation comparison
...
```{r pfs-con-sat-ot, warning=FALSE}
...
```{r pfs-con-mvc-sat-sli, warning=FALSE}
# 80% and final generation comparison
...
```{r pfs-con-mvc-act-sli, warning=FALSE}
# 80% and final generation comparison
end = filter(pfs_ot_mvc, diagnostic == 'contradictory_objectives' & gen == 50000)
end$Generation <- factor(end$gen)
...
```{r pfs-mpe-mvc-per-sli, warning=FALSE}
# 80% and final generation comparison
...
```{r pfs-mpe-mvc-act-sli, warning=FALSE}
# 80% and final generation comparison
end = filter(pfs_ot_mvc, diagnostic == 'multipath_exploration' & gen == 50000)
end$Generation <- factor(end$gen)
