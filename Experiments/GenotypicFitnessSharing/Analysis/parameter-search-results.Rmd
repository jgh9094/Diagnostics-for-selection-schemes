...
```{r gfs-ord-mvc-per-sli, warning=FALSE}
# 80% and final generation comparison
...
```{r gfs-con-mvc-sat-sli, warning=FALSE}
# 80% and final generation comparison
...
```{r gfs-mpe-mvc-per-sli, warning=FALSE}
# 80% and final generation comparison
